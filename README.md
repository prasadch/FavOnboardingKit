...
![AVPreview](https://github.com/prasadch/FavOnboardingKit/raw/refs/heads/main/AVPreview.gif)
...
```swift
dependencies: [
    .package(url: "https://github.com/prasadch/FavOnboardingKit.git", .upToNextMajor(from: "1.0.0"))
